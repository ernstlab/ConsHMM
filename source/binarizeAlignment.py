...
if __name__ == "__main__":
    ...
    required_main_args = parent_parser.add_argument_group('required arguments for any mode')
    required_main_args.add_argument('-s', '--seqFile', required=True, dest='seq_file',
                        help='Sequence file generated by parseMAF.py.')
    required_main_args.add_argument('-o', '--outputDirectory', required=True, dest='output_directory',
                        help='Output directory in which to put the binarized segments.')
    required_main_args.add_argument('-c', '--chr', required=True, dest='chromosome',
                        help='Chromosome of the reference species contained in the input file.')
    required_main_args.add_argument('-n', '--numBases', required=True, dest='num_bases', type=int,
    ...
    required_main_args.add_argument('-cl', '--chromLengths', required=True, dest='chromosome_sizes_file_name',
                        help='File containing the chrosomome lengths for the reference species in the alignment.')
    required_main_args.add_argument('-r', '--refSpecies', required=True, dest='reference_species',
                        help='Genome assembly name of the reference species in the alignment.')

    subparsers = parser.add_subparsers(title="Available modes", help='Run any mode with -h for more help')
    ...
    parser_reference.set_defaults(func=binarize_reference)
