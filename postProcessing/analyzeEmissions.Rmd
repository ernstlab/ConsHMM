...
To reorder your model and segmentation files, use the `Reorder` command in ChromHMM as below:
`java -jar ChromHMM.jar Reorder -noimage -f <column reordering file> -o <state renaming file> \
-r <original segmentation file> <reordered_segmentation_file> <original model file> <reordered model file>`
